...
<div class="card">
	...
	<div class="card-body">
		<form action="{{route('expenses.update', $expense->id)}}" method="post">
			...
			<input id="amount" name="amount" class="{{$errors->has('amount') ? 'bg-red-100 ': ' '}} block w-full mt-1 form-input" placeholder="Ingrese el monto del gasto" value="{{old('amount', $expense->amount)}}">
