...
<div class="card">
    <div class="card-header">
        <span class="text-lg font-medium">Registrar ingreso</span>
    </div>
    <div class="card-body">
        <form action="{{route('incomes.store')}}" method="post">
            ...
            <input id="amount" name="amount" class="{{$errors->has('amount') ? 'bg-red-100 ': ' '}} block w-full mt-1 form-input" placeholder="Ingrese la cantidad del ingreso" value="{{old('amount', '')}}">
            ...
            <input id="entry_date" name="entry_date" class="{{$errors->has('entry_date') ? 'bg-red-100 ' : ' '}} block w-full mt-1 form-input datepicker" placeholder="Ingrese la fecha del ingreso" autocomplete="off" readonly value="{{old('entry_date', '')}}">
